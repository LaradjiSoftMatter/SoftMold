/**
 * \brief Creates a bilayer membrane with rigid nanoparticles.
...
int main(int argc, char **argv)
{
	...
	System.setStoreInterval(0.01);
	System.setMeasureInterval(0.01);
	...
	constants[0]=1.0;//mass? It doesn't do anything yet, but mass would be nice
	...
	for(int i=0;i<nNanoparticles;i++)
	{
		...
		rigidSphere<double>(System, nanoPos[i], nanoRadius, 0.5*1.31345933134, unitCell, 4, constants, 1);
	}
