...
int main(int argc, char **argv)
{
	...
	brush<double>(System, nBrushes, nMonomers, pos, bondLength, arealDensity, constants, 4, 1.0, BB, BM,4000.0,0.1);
	...
	for(int i=0;i<nNanoparticles;i++)
	{
		...
		do
		{
			...
			toPlace.z= (((4*(nMonomers*0.7)) - (nanoRadius + 2)- ((nMonomers*0.7) + (nanoRadius + 2)))*randNum.rand53()) + ((nMonomers*0.7) + (nanoRadius + 2));
