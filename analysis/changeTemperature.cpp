...
int main(int argc, char **argv)
{
	if(argc!=4)
	{
		std::cout << argv[0] << " name initialTemperature finalTemperature\n";
		return 0;
	}

	double initialTemperature=atof(argv[2]);
	double finalTemperature=atof(argv[3]);
	...
	//Set a new time
	System.setInitialTemp(initialTemperature);
	System.setFinalTemp(finalTemperature);
